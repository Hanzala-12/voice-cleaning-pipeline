...
class AudioQualityProfiler:
    ...
    def profile_audio(self, audio: np.ndarray) -> Dict[str, any]:
        ...
        mid_energy_pct = frequency_spectrum.get('mid', 0) + frequency_spectrum.get('upper_mid', 0)
        ...
        logger.info(f"Audio profile complete: SNR={snr_estimate:.1f}dB, "
    ...
    def should_use_heavy_processing(self, profile: Dict) -> bool:
        ...
        noisy_with_voice = (profile['classifications']['is_noisy_spectrum'] and 
                           profile['classifications']['has_voice_characteristics'])
