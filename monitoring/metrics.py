...
active_jobs = Gauge("voice_cleaning_active_jobs", "Number of currently processing jobs")

model_load_time = Histogram(
    "model_load_time_seconds", "Time to load models", ["model_type"]
)

errors_total = Counter(
    "voice_cleaning_errors_total", "Total number of errors", ["error_type"]
)
